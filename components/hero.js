...
const HeroLink = ({children, href}) => {
  return (
    <a
      href={href}
      className="hover:bg-black rounded-md p-3 -m-3 font-bold text-celonis"
    >
      {children}
    </a>
  )
...
export const Hero = () => {
  return (
    <section className="container max-w-5xl mx-auto my-12 py-16 px-4 flex flex-col justify-center">
      <h1 className="text-white font-bold text-4xl md:text-[4rem] tracking-wide font-mono uppercase leading-tight md:leading-tight">
